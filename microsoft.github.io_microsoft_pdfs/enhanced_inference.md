AutoGen Search Use CasesEnhanced Inference On this page
...
1. Validation data. 2. Evaluation function. 3. Metric to optimize. 4. Search space. 5. Budgets: inference and optimization respectively.
